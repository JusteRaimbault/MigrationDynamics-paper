...
%We choose to focus on particular processes and stylized facts to include in the agent-based models \comment{modif.}, in order to test some hypothesis formulated after qualitative research done in~\cite{losavio2016analyser}.
The model is designed to include specific stylized facts and experiments.
...
%The world \comment{Why do you talk about the “world” ? Do you mean the world of our model?}[yes it is a term for the space of the model] consists
